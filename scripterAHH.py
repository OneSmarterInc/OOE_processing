...
scripts = [
    r'C:\Users\abc-admin\Desktop\OOE\EDI_PROJECT-\EDI-Backend\FTP2RacAHH.py'
]
...
# #     subprocess.run(['python', 'C:\\Users\\abc-admin\\Desktop\\file_auto\\EDI_PROJECT-\\EDI-Backend\\sftpToServerExcludingName.py'])
